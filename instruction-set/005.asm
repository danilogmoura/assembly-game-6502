...
Start:
    CLD                 ; Certifique-se de que o modo decimal está limpo (desativado)
    LDA #$0A            ; Carregue o registrador A com o valor hexadecimal $A
    LDX #%1010          ; Carregue o registrador X com o valor binário %1010
     
    STA $80             ; Armazene o valor no registrador A no endereço de memória (página zero) $80
    STX $81             ; Armazene o valor no registrador X no endereço de memória (página zero) $81
 
    LDA #10             ; Carregue A com o valor decimal 10

    CLC                 ; Limpe o bit de carry
    ADC $80             ; Adicione a A o valor dentro do endereço RAM $80
    ADC $81             ; Adicione a A o valor dentro do endereço RAM $81

                        ; A deve conter (#10 + $A + %1010) = #30 (ou $1E em hexadecimal)
