...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; 
    seg.u Variables
    org $80
P0Height ds 1                   ; define 1byte para a altura do player 0
P1Height ds 1                   ; define 1byte para a altura do player 1
...
Reset:
    ...
    lda #10                     ; altura do player 0
    sta P0Height                ; armazena a altura do player 0 na variável P0Height
    sta P1Height                ; armazena a altura do player 1 na variável P1Height
...
Player0Loop:
    ...
    sta WSYNC
    iny
    cpy P0Height                    ; verifica se chegou na altura do player 0
    bne Player0Loop
...
Player1Loop:
    ...
    sta WSYNC
    iny
    cpy P1Height                    ; verifica se chegou na altura do player 1
    bne Player1Loop
